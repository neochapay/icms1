...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        22 => array(
            ...
            'Compass','Gyroscope','HolsterSensor','IRProximitySensor','LightSensor',
            'Magnetometer','OrientationSensor','PressureSensor','ProximitySensor',
            'RotationSensor','SensorGesture','SensorGlobal','TapSensor','TiltSensor',
            'AccelerometerReading','AltimeterReading','AmbientLightReading','AmbientTemperatureReading',
            'CompassReading','GyroscopeReading','HolsterReading','IRProximityReading',
            'LightReading','MagnetometerReading','OrientationReading','PressureReading',
            'ProximityReading','RotationReading','TapReading','TiltReading','AccelerometerReading',
            'AltimeterReading','AmbientLightSensor','AmbientLightReading','AmbientTemperatureSensor',
            'AmbientTemperatureReading','CompassReading','GyroscopeReading','HolsterReading',
            'IRProximityReading','LightReading','MagnetometerReading','OrientationReading',
            'PressureReading','ProximityReading','RotationReading','SensorReading','TapReading','TiltReading'
            ),
